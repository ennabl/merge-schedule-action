...
export function setupWebhooksFolder(subPath:string) {
    mkdirSync(`${tempPath}/${subPath}`, {recursive: true});
}

export function cleanupWebhooksFolder(subPath:string) {
    rmSync(`${tempPath}/${subPath}`, {recursive: true});
}
